<p>[img src="https://business.livingxworld.com/images/firstheberg.png" alt="firstheberg" style="display: block; margin-left: auto; margin-right: auto; width: 300px; height: 300px;" /]</p>
<hr id="system-readmore" />

<h2 style="text-align: center;"><span style="text-decoration: underline;"><strong>Presentation</strong></span></h2>

 <p><strong>Description:</strong> Firstheberg, your specialist in shared hosting, dedicated servers and VPS since 2010. Discover our complete offer from 1.49 € / month.</p>
...
[begins tags="div" class="row" /]
	...
	[begins tags="div" class="col-xs-12 col-md-8" /]
		[h3]map[/h3]
		[mapbox-custom parent="high-tech" category="server-europe" entreprise="firstheberg" /]
...
[begins tags="div" class="row text-center" /]
	[begins tags="div" class="col-xs-12 col-md-12" /]
		[h3]owner site[/h3]
		[whois-domains url="firstheberg.com" /] 
	[ends tags="div" /]	
	[begins tags="div" class="col-xs-12 col-md-12" /]
		[h3]HTTPS: SSL/TLS[/h3]
		[ssllabs domains="firstheberg.com" /]
		[h3]Your data are:[/h3]
		[api-myipms query="firstheberg.com" /]
...
[begins tags="div" class="row text-center" /]
	[begins tags="div" class="col-xs-12 col-md-6" /]
		[h3]Badge[/h3]
		[lxw-badge parent="high-tech" category="server/europeen" entreprise="firstheberg" showembed="yes" /]
...
[begins tags='script' more='type="application/ld+json"' /] 
	{
		...
		"description": "Firstheberg, your specialist in shared hosting, dedicated servers and VPS since 2010. Discover our complete offer from 1.49 € / month.",
